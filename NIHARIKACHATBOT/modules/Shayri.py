import random
from NIHARIKACHATBOT.database import get_served_chats
...
@NIHARIKACHATBOT.on_message(filters.command(SHAYRI_COMMAND))
            ...
            [
                [
                    InlineKeyboardButton(
                        "❍ 𝐒ᴜᴘᴘᴏʀᴛ ❍", url=f"https://t.me/Crush_Forever"
                    ),
                    InlineKeyboardButton(
                        "❍ 𝐔ᴘᴅᴀᴛᴇ ❍", url=f"https://t.me/Forever_Crush_Hub"
                    ),
                ]
            ]
        ),
