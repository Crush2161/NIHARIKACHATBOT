...
from NIHARIKACHATBOT import OWNER, NIHARIKACHATBOT
...
START_BOT = [
    [
        InlineKeyboardButton(
            ...
            url=f"https://t.me/{NIHARIKACHATBOT.username}?startgroup=true",
        ),
    ],
    [
...
HELP_BUTN = [
    [
        InlineKeyboardButton(
            text="❍ 𝐇ᴇʟᴘ ❍", url=f"https://t.me/{NIHARIKACHATBOT.username}?start=help"
        ),
        InlineKeyboardButton(text="❍ 𝐂ʟᴏ𝐬ᴇ ❍", callback_data="CLOSE"),
    ],
]
