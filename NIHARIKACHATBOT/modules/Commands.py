...
from NIHARIKACHATBOT.database.chats import add_served_chat
from NIHARIKACHATBOT.database.users import add_served_user
from config import MONGO_URL, OWNER_ID
from NIHARIKACHATBOT import NIHARIKACHATBOT, mongo, LOGGER, db
from NIHARIKACHATBOT.modules.helpers import chatai, storeai, languages, CHATBOT_ON
...
@NIHARIKACHATBOT.on_message(filters.command(["lang", "language", "setlang"]))
...
@NIHARIKACHATBOT.on_message(filters.command("status"))
...
@NIHARIKACHATBOT.on_message(filters.command(["resetlang", "nolang"]))
...
@NIHARIKACHATBOT.on_message(filters.command("chatbot"))
