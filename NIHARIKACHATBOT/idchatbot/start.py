...
from NIHARIKACHATBOT.idchatbot.helpers import is_owner
...
import time
import io
from NIHARIKACHATBOT import CLONE_OWNERS, db, NIHARIKACHATBOT
...
from NIHARIKACHATBOT.idchatbot.helpers import (
    START,
    START_BOT,
    PNG_BTN,
    CLOSE_BTN,
...
async def add_bot_to_chats():
    try:
        ...
        bot = await NIHARIKACHATBOT.get_users(users)
        bot_id = bot.id
